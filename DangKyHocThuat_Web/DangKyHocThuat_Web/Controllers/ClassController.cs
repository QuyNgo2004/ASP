...
namespace DangKyHocThuat_Web.Controllers
{
    public class ClassController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Save_Data(Class p_objRequest)
        {
            try
            {
        ...
        private void Update_Data(Class p_objRequest)
        {
            ...
            _context.Classes.Update(p_objRequest);
            _context.SaveChanges();
        }

        private void Add_Data(Class p_objRequest)
        {
            if (p_objRequest.ClassName.Trim() == "")
                throw new Exception("Mã lớp không được để trống.");
            ...
            _context.Classes.Add(p_objRequest);
            _context.SaveChanges();
        }
